...
// Same fire-particles-rising visual treatment used on the other Onyx
// prompt/generation nodes (see ofm_prompt_generator.js / prompt_selector.js /
// onyx_speed_hd_sampler.js), applied here to both nodes from
// onyx_eye_detailer.py for brand consistency across the pack.
const ONYX_DETAILER_CLASSES = ["OnyxDetailer", "OnyxEyeBBoxDetectorProvider"];

app.registerExtension({
    name: "onyx.EyeDetailer",
    nodeCreated(node) {
        if (!ONYX_DETAILER_CLASSES.includes(node.comfyClass)) return;
